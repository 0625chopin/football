...
export const match: MatchMessages = {
  ...
  timeline: {
    ...
    emptyKickoffPending: "No events yet (kickoff pending)",
    liveAnnouncement: "{minute}', {eventLabel}, {playerName}",
  },
  news: {
  ...
  bracket: {
    ...
    tbd: "TBD",
    zoomGroupLabel: "Bracket zoom",
    zoomOutLabel: "Zoom out",
    zoomInLabel: "Zoom in",
    zoomResetLabel: "Reset",
    zoomLevelFormat: "{percent}%",
    roundNavGroupLabel: "Round navigation",
    prevRoundLabel: "Previous round",
