...
/**
 * `/[lang]` not-found 폴백 — Task 005(13일차) 골격, I-170(35일차, 4팀) 쿠키 근사 적용.
 *
...
export default async function NotFound() {
  ...
  return (
    <main className="p-4 text-sm">
      <h2 className="font-semibold">{t(locale, "error.notFound.title")}</h2>
      <p className="text-foreground/60">{t(locale, "error.notFound.description")}</p>
    </main>
  );
}
