...
| E-41 | CommonCodeGroup | 13 | 13 | 0 | |
| E-42 | CommonCode | 16 | 16 | 0 | `world_id`는 TS 원본 필드(물리 전용 아님, §3.11 각주) |
...
*이 문서는 12일차 작업으로 최종본이 되었다(§6.3 RLS·생명주기, §8 필드 대응표 추가). 누적 반영 — 9일차(§0~§3 개요·47엔티티 테이블) + 10일차(§6.1 관계 서술 R-01~R-13) + 11일차(§6.2 인덱스 설계, 14개 공식 인덱스 + 이월분 6건) + 12일차(§6.3 RLS 정책 초안·데이터 생명주기, §8 도메인 타입 필드 대응표 — H-08 인계). Task 009(ROADMAP.md) 전 구현 사항 완료, 마이그레이션은 13일차(Task 032) 이후 별도 진행.*
